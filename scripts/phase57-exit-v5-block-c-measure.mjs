...
const supportive=eligible.length>=10&&deltaVsV4>0&&Number(arms.v5.profitFactor)>=Number(arms.v4.profitFactor)&&ddWorsening<=1&&top1AbsShare<0.8;
const reject=deltaVsV4<=0||ddWorsening>1;
const finalDecision=supportive?'BLOCK_C_SUPPORTIVE':reject?'BLOCK_C_REJECT':'BLOCK_C_MIXED';
