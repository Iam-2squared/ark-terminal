...
const measurement={status:'MARKETWIDE_DYNAMIC_5M_MEASUREMENT_READY',inputSymbols:3697,selectedSymbols:36,safety:safety()};
...
test('four-track package binds durable references and remains research-only',()=>{
  ...
  assert.equal(x.tracks.dynamic5m.selectedCount,36);
