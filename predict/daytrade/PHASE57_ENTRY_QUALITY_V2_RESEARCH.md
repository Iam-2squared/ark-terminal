...
No Entry v2 model has been fitted and no threshold has been tuned. Model research remains blocked by the below-500 checkpoint, incomplete universe/survivorship and corporate-action audits, incomplete golden OHLCV parity, and unfrozen Development/Validation/Untouched-OOS time boundaries. CI success or candidate count alone is not evidence of better trading performance.
