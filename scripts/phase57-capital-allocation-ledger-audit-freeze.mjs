...
Status: **LEDGER_AUDIT_PRESERVED / DEVELOPMENT_MAIN_MAX_3_FROZEN / FUTURE_OOS_PRECOMMITTED_NOT_OPENED**
...
## Development selection lineage and current roles

- MAX_5 was the PRIMARY_DEVELOPMENT_CANDIDATE at this ledger-audit stage
- MAX_10: LEGACY_BUDGET_BASELINE
- MAX_3 was the AGGRESSIVE_DEVELOPMENT_REFERENCE at this ledger-audit stage
- After A/B/Old20 exposed remeasurement, the user explicitly froze MAX_3 as Main and MAX_5 as Conservative Sub before future Integrated OOS exists
- Current Main: Frozen Minimal Hybrid v1 x MSH-Entry v1 x V3_B_RISK x MAX_3 x EXIT_V5_DYNAMIC_RECLAIM_BAR_5
...
The first 20 eligible sessions from 2026-10-22 are precommitted. The Integrated OOS runner and output schema are ready but locked. No future/OOS source was opened or measured. A separate hash-bound authorization contract is required before execution.
