# JPX Stock Behavior Dictionary v1 — STOP
...
Protocol precommit `049ea1bb465fbf09cbf8af60c1aa1b5577467515`. Latest starting HEAD `54e9be66ca1c1c06c19ae261f1dc9122f6b63312`; exact producing HEAD/CI receipt is29_ci.json. No overwrite of prior evidence.
...
Audited 57/57 existing full-cross-section Development sessions, 23,665,523 raw1m rows, 250,450 daily rows, 250,450 dated-master rows. Dated common-equity code-days with minute observations 216,040/218,319 (98.96%); observed regular minute slots 31.61%. Sparse5m buckets 5,896,388; absent slots 46,426,330, reason UNKNOWN rather than NO_TRADE. These are raw coverage proxies, not PIT-valid stable-security coverage.
