...
const requested=universe.slice(start,start+count);
...
const payload={
  ...
  universe:{path:universePath,sourceDate:universePayload?.meta?.sourceDate??null,start,count,requested:requested.length},
